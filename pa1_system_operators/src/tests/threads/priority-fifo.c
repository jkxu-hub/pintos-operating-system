...
//---at this point main:pri= 33 and 16 thread have pri=32
  thread_set_priority (PRI_DEFAULT);
  /* All the other threads now run to termination here. */
  ASSERT (lock.holder == NULL);
//---at this point main:pri= 31 and 16 thread have pri=32
// it is our job to add thread_yield to thread_set_priority
  cnt = 0;
